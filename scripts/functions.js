...
// TRANSITION DOESN'T WANT TO WORK -- WHY?
/********************************
        CHANGE TRANSITION
********************************/
function changeTransition() {
  ...
  // Grab Transform Input Value
  let transition = document.getElementById("changeTransition").value;

  // Grab Container for changing Transform styling
  document.getElementById("example1").style.transition = transition;

  // Set property for CSS Variable
  let example1 = document.getElementById("example1");
  example1.style.setProperty('--transition', transition);
...
function newProperty() {
  ...
  let div7 = document.getElementById('properties');
  let selector7 = document.querySelector('#property7');
  ...
  element7.innerHTML = '<label>Change Transition: </label><input type="text" id="changeTransition" placeholder="width 1s linear">';
  div7.insertBefore(element7, selector7.nextSibling);
...
function resetForm() {
  ...
  example1.style.transition = "none";
  example1.style.animation = "none";
...
/********************************
        CHANGE VIDEO SIZE
********************************/
let video = document.getElementById("video-example");

function videoEnlarge() {
  video.style.transition = "all .75s linear"; // transition + transform?
  video.style.transform = "translate(8rem, 5rem) scale(1.5)";
  video.width = "500px";
}

function videoNormal() {
  video.style.animation = "normal-video 1.5s linear";
}
...
window.onload = function() {
  ...
  ctx.drawImage(img, 0, 0, 250, 180);
};

var screaming = document.getElementById("screaming");
var text = screaming.getContext("2d");
text.font = "30px Arial";
text.fillText("Ahhhhhhhhhhhh!",10,25);
